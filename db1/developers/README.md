...
Part of the **Pixovia LLC** full database archive — DB1 (Apps Platform).

Contains developer profiles from the Pixovia platform.

| File | Description |
|---|---|
| `schema.sql` | Supabase PostgreSQL table schema |
| `data.csv` | Exported developer profiles data |
